...
:setvar DefaultDataPath "C:\Users\j.conrad\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
:setvar DefaultLogPath "C:\Users\j.conrad\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
...
CREATE TABLE [dbo].[Condition] (
    ...
    PRIMARY KEY CLUSTERED ([Condition_State] ASC)
);
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_Copy_Condition]...';


GO
ALTER TABLE [dbo].[GameCopy]
    ADD CONSTRAINT [FK_Copy_Condition] FOREIGN KEY ([Copy_Condition]) REFERENCES [dbo].[Condition] ([Condition_State]);
