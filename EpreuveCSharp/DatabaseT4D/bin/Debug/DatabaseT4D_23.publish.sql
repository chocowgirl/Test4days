...
INSERT INTO [User] ([Email], [Password], [Pseudo], [Salt]) VALUES ('jane.doe@hotmail.com', CONVERT(VARBINARY, 'Test1234='), 'PseudoJane', CAST('3f5d6c8a-7e12-4b9a-bf25-9a3d2eab4f68' AS UNIQUEIDENTIFIER));
...
INSERT INTO [GameCopy] ([Jeu_Id], [UserOwner_Id], [Copy_Condition]) VALUES (1, CAST('c2df3495-3d95-4b8e-a3d0-001bee780b85' AS UNIQUEIDENTIFIER), 'incomplete');
GO
